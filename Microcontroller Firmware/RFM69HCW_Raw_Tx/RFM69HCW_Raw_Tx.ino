...
// Use 434.0 for RFM96HCW / 915.0 for RFM95HCW
...
int16_t packetnum = 0;  // Packet counter... Incremented after every Tx
...
void setup() {
  ...
  digitalWrite(RFM69_RST, LOW); //Pull RST pin low to turn on the RFM69HCW module
  ...
  // Defaults after init to 434.0MHz, modulation GFSK_Rb250Fd250, +13dbM (for low power module), no encryption
